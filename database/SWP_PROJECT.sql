...
[expiryTime] [datetime] DEFAULT CURRENT_TIMESTAMP ,
[isUsed] [bit] NOT NULL,
[user_id] [int] NOT NULL,
...
SET QUOTED_IDENTIFIER ON
GO
CREATE TABLE [dbo].[Questions_Listening_Write](
...
SET QUOTED_IDENTIFIER ON
GO
CREATE TABLE [dbo].[Questions_Speaking](
...
GO
ALTER TABLE [dbo].[Answer_Listening_Write]  WITH CHECK ADD  CONSTRAINT [FK_Answer_Listening_Write_Questions_Listening_Write] FOREIGN KEY([quest_Listen])
REFERENCES [dbo].[Questions_Listening_Write] ([quest_Listen])
GO
ALTER TABLE [dbo].[Answer_Listening_Write] CHECK CONSTRAINT [FK_Answer_Listening_Write_Questions_Listening_Write]
GO
...
GO
ALTER TABLE [dbo].[Answer_Speaking]  WITH CHECK ADD  CONSTRAINT [FK_Answer_Speaking_Speaking] FOREIGN KEY([quest_Speak])
REFERENCES [dbo].[Speaking] ([speak_id])
GO
ALTER TABLE [dbo].[Answer_Speaking] CHECK CONSTRAINT [FK_Answer_Speaking_Speaking]
GO
...
GO
ALTER TABLE [dbo].[BrandPoint_Speaking]  WITH CHECK ADD  CONSTRAINT [FK_BrandPoint_Speaking_Questions_Speaking] FOREIGN KEY([quest_id])
REFERENCES [dbo].[Questions_Speaking] ([quest_Speak])
GO
ALTER TABLE [dbo].[BrandPoint_Speaking] CHECK CONSTRAINT [FK_BrandPoint_Speaking_Questions_Speaking]
GO
...
GO
ALTER TABLE [dbo].[Questions_Listening_Write]  WITH CHECK ADD  CONSTRAINT [FK_Questions_Listening_Write_Listening] FOREIGN KEY([listen_id])
REFERENCES [dbo].[Listening] ([listen_id])
GO
ALTER TABLE [dbo].[Questions_Listening_Write] CHECK CONSTRAINT [FK_Questions_Listening_Write_Listening]
GO
ALTER TABLE [dbo].[Questions_Speaking]  WITH CHECK ADD  CONSTRAINT [FK_Questions_Speaking_Speaking] FOREIGN KEY([speak_id])
REFERENCES [dbo].[Speaking] ([speak_id])
GO
ALTER TABLE [dbo].[Questions_Speaking] CHECK CONSTRAINT [FK_Questions_Speaking_Speaking]
GO
...
GO
ALTER TABLE [dbo].[Comment] ADD  CONSTRAINT [DF_Comment_created_at]  DEFAULT (getdate()) FOR [created_at]
GO
ALTER TABLE [dbo].[Comment] ADD  CONSTRAINT [DF_Comment_update_time]  DEFAULT (getdate()) FOR [update_time]
GO
