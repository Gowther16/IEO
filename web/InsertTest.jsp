    ...
    <form action="insertTest" method="post">
        ...
        <div class="content">
                    ...
                    <div class="question-container">
                        ...
                        <div class="answerOptionsContainer">
                            <div class="answer-option">
                                ...
                                <input type="radio" id="correctAnswerR1_1" name="correctAnswerR_1" value="0" required>
            ...
            <div id="listening" class="tab">
                <h1>Listening</h1>
                <input type="file" name="listeningFile" accept=".mp3" required><br>
                ...
                <div id="questionsContainerListening" class="questions-container">
                    <div class="question-container">
                        ...
                        <div class="answerOptionsContainer">
                            <div class="answer-option">
                                <label for="answerOptionL1_1">Option 1:</label>
                                <input type="text" id="answerOptionL1_1" name="answerOptionL_1_1" required>
                                <input type="radio" id="correctAnswerL1_1" name="correctAnswerL_1" value="0" required>
