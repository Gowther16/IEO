...
public class Answer_Listening_WriteDAO {
    ...
    public List<Answer_Listening_Write> getAllAnswerListeningWrite(){
        ...
        try {
            ...
            while (rs.next()) {
                Answer_Listening_Write answer = new Answer_Listening_Write();
                answer.setAnswer_id(rs.getInt("answer_id"));
                answer.setQuest_Listen(rs.getInt("quest_Listen"));
